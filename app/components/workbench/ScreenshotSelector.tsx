  ...
  ({ isSelectionMode, setIsSelectionMode, containerRef }: ScreenshotSelectorProps) => {
    ...
    const initializeStream = async () => {
      if (!mediaStreamRef.current) {
        try {
          ...
          setIsSelectionMode(false);
          toast.error(getTranslation('failedToInitScreenCapture', languageStore.get()));
        }
      }
    ...
    const handleCopySelection = useCallback(async () => {
      ...
      try {
        ...
        reader.onload = (e) => {
          ...
          if (textarea) {
            ...
            if (setUploadedFiles && setImageDataList) {
              ...
              toast.success(getTranslation('screenshotCaptured', languageStore.get()));
            } else {
              toast.error(getTranslation('couldNotAddScreenshot', languageStore.get()));
            }
          }
        };
        ...
        toast.error(getTranslation('failedToCaptureScreenshot', languageStore.get()));
