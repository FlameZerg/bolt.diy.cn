      ...
      >
        <div className="flex items-start">
          ...
          <div className="ml-3 flex-1">
            ...
            >
              {getTranslation(title as any, language)}
            </motion.h3>
            <motion.div
              initial={{ opacity: 0 }}
              animate={{ opacity: 1 }}
            ...
            >
              <p>{getTranslation(description as any, language)}</p>
                ...
                <div className="mt-4 mb-2">
                  <div className="flex items-center space-x-2 mb-3">
                    ...
                    <div className="flex items-center">
                      ...
                      <span className="ml-2">{getTranslation('build', language)}</span>
                    </div>
                    ...
                    <div className="flex items-center">
                      ...
                      <span className="ml-2">{getTranslation('deploy', language)}</span>
                    </div>
                  </div>
                </div>
              )}
              ...
              {url && type === 'success' && (
                <div className="mt-2">
                  ...
                  >
                    <span className="mr-1">{getTranslation('viewDeployedSite', language)}</span>
            ...
            >
              <div className={classNames('flex gap-2')}>
                {type === 'error' && (
                  <button
                    onClick={() =>
                      postMessage(getTranslation('fixError', language).replace('{error}', content || description))
                    }
                    className={classNames(
                  ...
                  >
                    ...
                    {getTranslation('askBolt', language)}
                  </button>
                )}
                <button
                  onClick={clearAlert}
