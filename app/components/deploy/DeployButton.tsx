    ...
    <>
      <div className="flex border border-bolt-elements-borderColor rounded-md overflow-hidden text-sm">
        <DropdownMenu.Root>
          ...
          >
            {isDeploying ? `${getTranslation('deployingTo', language)} ${deployingTo}...` : getTranslation('deploy', language)}
          ...
          >
            ...
            >
              ...
              <span className="mx-auto">
                {!netlifyConn.user ? getTranslation('noNetlifyConnected', language) : getTranslation('deployToNetlify', language)}
              </span>
            ...
            >
              <img
                ...
                alt="vercel"
              />
              <span className="mx-auto">{!vercelConn.user ? getTranslation('noVercelConnected', language) : getTranslation('deployToVercel', language)}</span>
            ...
            >
              <img
                ...
                alt="github"
              />
              <span className="mx-auto">{getTranslation('deployToGitHub', language)}</span>
            </DropdownMenu.Item>
            ...
            >
              <img
                ...
                alt="gitlab"
              />
              <span className="mx-auto">{!gitlabIsConnected ? getTranslation('noGitLabConnected', language) : getTranslation('deployToGitLab', language)}</span>
            </DropdownMenu.Item>
            ...
            >
              <img
                ...
                alt="cloudflare"
              />
              <span className="mx-auto">{getTranslation('deployToCloudflare', language)}</span>
            </DropdownMenu.Item>
          </DropdownMenu.Content>
        </DropdownMenu.Root>
      </div>
