  ...
  const handleGitLabDeploy = async () => {
    ...
    try {
      ...
      workbenchStore.addArtifact({
        ...
        title: getTranslation('deploymentTitle', language).replace('{provider}', 'GitLab'),
        type: 'standalone',
      });
      ...
      toast.success(getTranslation('preparationSuccess', language).replace('{provider}', 'GitLab'));
      ...
      toast.error(err instanceof Error ? err.message : getTranslation('preparationFailed', language).replace('{provider}', 'GitLab'));
