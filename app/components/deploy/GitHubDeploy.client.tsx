  ...
  const handleGitHubDeploy = async () => {
    ...
    try {
      ...
      workbenchStore.addArtifact({
        ...
        title: getTranslation('deploymentTitle', language).replace('{provider}', 'GitHub'),
        type: 'standalone',
      });
      ...
      toast.success(getTranslation('preparationSuccess', language).replace('{provider}', 'GitHub'));
      ...
      toast.error(err instanceof Error ? err.message : getTranslation('preparationFailed', language).replace('{provider}', 'GitHub'));
