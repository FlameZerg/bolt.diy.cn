    ...
    artifact?.type === 'bundled'
      ? allActionFinished
        ? artifact.id === 'restored-project-setup'
          ? getTranslation('projectRestored', language)
          : getTranslation('projectCreated', language)
        : artifact.id === 'restored-project-setup'
          ? getTranslation('restoringProject', language)
          : getTranslation('creatingProject', language)
      : artifact?.title;
          ...
          >
            <div className="px-5 p-3.5 w-full text-left">
              ...
              <div className="w-full w-full text-bolt-elements-textSecondary text-xs mt-0.5">
                {getTranslation('clickToOpenWorkbench', language)}
              </div>
            </div>
          </button>
        ...
        {artifact.type === 'bundled' && (
          <div className="flex items-center gap-1.5 p-5 bg-bolt-elements-actions-background border-t border-bolt-elements-artifacts-borderColor">
            ...
            <div className="text-bolt-elements-textPrimary font-medium leading-5 text-sm">
              {allActionFinished
                ? artifact.id === 'restored-project-setup'
                  ? getTranslation('restoreFilesFromSnapshot', language)
                  : getTranslation('initialFilesCreated', language)
                : getTranslation('creatingInitialFiles', language)}
            </div>
          </div>
        )}
        <AnimatePresence>
