              ...
              <div className="space-y-4">
                <DialogTitle>
                  <img
                    ...
                    src="https://cdn.simpleicons.org/supabase"
                  />
                  {getTranslation('connectToSupabase', language)}
                </DialogTitle>
                ...
                <div className="flex justify-end gap-2 mt-6">
                  <DialogClose asChild>
                    <DialogButton type="secondary">{getTranslation('cancel', language)}</DialogButton>
                  </DialogClose>
                  <button
              ...
              <div className="space-y-4">
                <div className="flex items-center justify-between mb-2">
                  <DialogTitle>
                    <img
                      ...
                      src="https://cdn.simpleicons.org/supabase"
                    />
                    {getTranslation('supabaseConnection', language)}
                  </DialogTitle>
                </div>
                ...
                <div className="flex items-center gap-4 p-3 bg-[#F8F8F8] dark:bg-[#1A1A1A] rounded-lg">
                  <div>
                    ...
                    <p className="text-xs text-bolt-elements-textSecondary">{getTranslation('role', language)}: {supabaseConn.user?.role}</p>
                  </div>
                </div>
                ...
                {fetchingStats ? (
                  <div className="flex items-center gap-2 text-sm text-bolt-elements-textSecondary">
                    ...
                    {getTranslation('fetchingProjects', language)}
                  </div>
                ) : (
                  <div>
                    <div className="flex items-center justify-between mb-2">
                      ...
                      >
                        ...
                        {getTranslation('yourProjects', language)} ({supabaseConn.stats?.totalProjects || 0})
                        <div
                          className={classNames(
                      ...
                      <div className="flex items-center gap-2">
                        <button
                          ...
                          title={getTranslation('refreshProjectsList', language)}
                        >
                        ...
                        >
                          ...
                          {getTranslation('newProject', language)}
                        </button>
                      </div>
                    </div>
                      ...
                      <>
                        {!supabaseConn.selectedProjectId && (
                          <div className="mb-2 p-3 bg-[#F8F8F8] dark:bg-[#1A1A1A] rounded-lg text-sm text-bolt-elements-textSecondary">
                            {getTranslation('selectProjectHint', language)}
                          </div>
                        )}
                                  ...
                                  >
                                    {supabaseConn.selectedProjectId === project.id ? (
                                      <span className="flex items-center gap-1">
                                        ...
                                        {getTranslation('selected', language)}
                                      </span>
                                    ) : (
                ...
                <div className="flex justify-end gap-2 mt-6">
                  <DialogClose asChild>
                    <DialogButton type="secondary">{getTranslation('close', language)}</DialogButton>
                  </DialogClose>
