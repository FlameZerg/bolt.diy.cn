      ...
      {shouldShowButtons && (
        <div className="flex border border-bolt-elements-borderColor rounded-md overflow-hidden text-sm">
          <button
            ...
            title={getTranslation('reportBug', language)}
          >
            <div className="i-ph:bug" />
            <span>{getTranslation('reportBug', language)}</span>
          </button>
          ...
          <button
            ...
            title={getTranslation('downloadDebugLog', language)}
          >
            <div className="i-ph:download" />
            <span>{getTranslation('downloadDebugLog', language)}</span>
          </button>
        </div>
      )}
    </div>
