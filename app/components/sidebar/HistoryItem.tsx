        ...
        >
          ...
          >
            <div className="flex items-center gap-2.5 text-gray-400 dark:text-gray-500 opacity-0 group-hover:opacity-100 transition-opacity">
              <ChatActionButton
                toolTipContent={getTranslation('export', language)}
              ...
              {onDuplicate && (
                <ChatActionButton
                  toolTipContent={getTranslation('duplicate', language)}
              ...
              <ChatActionButton
                toolTipContent={getTranslation('rename', language)}
              ...
              />
              <ChatActionButton
                toolTipContent={getTranslation('delete', language)}
