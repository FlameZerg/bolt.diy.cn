...
export function ConfirmationDialog({
  ...
  const finalConfirmLabel = confirmLabel || getTranslation('confirm', language);
  const finalCancelLabel = cancelLabel || getTranslation('cancel', language);
      ...
      <Dialog showCloseButton={false}>
        <div className="p-6 bg-white dark:bg-gray-950 relative z-10">
          ...
          <DialogDescription className="mt-2 mb-4">
            {getTranslation('selectItemsDesc', language)} <span className="text-bolt-elements-item-contentAccent font-medium">{finalConfirmLabel}</span>.
          </DialogDescription>

          <div className="py-4">
            <div className="flex items-center justify-between mb-4">
              <span className="text-sm font-medium text-bolt-elements-textSecondary">
                {getTranslation('selectedItemsCount', language)
              ...
              >
                {selectAll ? getTranslation('deselectAll', language) : getTranslation('selectAll', language)}
              </Button>
            </div>
            ...
            >
              {items.length > 0 ? (
                ...
                <div className="text-center py-4 text-sm text-bolt-elements-textTertiary">{getTranslation('noItemsToDisplay', language)}</div>
              )}
            </div>
          </div>
