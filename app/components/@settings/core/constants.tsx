...
export const TAB_LABELS: Record<TabType, string> = {
  ...
  data: 'tabDataManagement',
  'cloud-providers': 'tabCloudProviders',
  'local-providers': 'tabLocalProviders',
  github: 'tabGitHub',
  gitlab: 'tabGitLab',
  netlify: 'tabNetlify',
  vercel: 'tabVercel',
  supabase: 'tabSupabase',
  'event-logs': 'tabEventLogs',
  mcp: 'tabMcpServers',
};

export const TAB_DESCRIPTIONS: Record<TabType, string> = {
  profile: 'tabProfileDesc',
  settings: 'tabSettingsDesc',
  notifications: 'tabNotificationsDesc',
  features: 'tabFeaturesDesc',
  data: 'tabDataManagementDesc',
  'cloud-providers': 'tabCloudProvidersDesc',
  'local-providers': 'tabLocalProvidersDesc',
  github: 'tabGitHubDesc',
  gitlab: 'tabGitLabDesc',
  netlify: 'tabNetlifyDesc',
  vercel: 'tabVercelDesc',
  supabase: 'tabSupabaseDesc',
  'event-logs': 'tabEventLogsDesc',
  mcp: 'tabMcpServersDesc',
};
