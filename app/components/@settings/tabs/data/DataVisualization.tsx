  ...
  if (chats.length === 0) {
    return (
      <div className="text-center py-8">
        ...
        <h3 className="text-lg font-medium text-bolt-elements-textPrimary mb-2">{getTranslation('noDataAvailable', language)}</h3>
        <p className="text-bolt-elements-textSecondary">
          {getTranslation('noDataDesc', language)}
        </p>
      </div>
    );
  }
    ...
    <div className="space-y-8">
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div className={cardClasses}>
          <h3 className="text-lg font-medium text-bolt-elements-textPrimary mb-4">{getTranslation('totalChats', language)}</h3>
        ...
        <div className={cardClasses}>
          <h3 className="text-lg font-medium text-bolt-elements-textPrimary mb-4">{getTranslation('totalMessages', language)}</h3>
          <div className={statClasses}>
        ...
        <div className={cardClasses}>
          <h3 className="text-lg font-medium text-bolt-elements-textPrimary mb-4">{getTranslation('avgMessagesPerChat', language)}</h3>
          <div className={statClasses}>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div className={cardClasses}>
          <h3 className="text-lg font-medium text-bolt-elements-textPrimary mb-6">{getTranslation('chatHistory', language)}</h3>
          <div className="h-64">
        ...
        <div className={cardClasses}>
          <h3 className="text-lg font-medium text-bolt-elements-textPrimary mb-6">{getTranslation('messageDistribution', language)}</h3>
          <div className="h-64">
      ...
      {apiKeyUsage.length > 0 && (
        <div className={cardClasses}>
          <h3 className="text-lg font-medium text-bolt-elements-textPrimary mb-6">{getTranslation('apiUsageByProvider', language)}</h3>
          <div className="h-64">
