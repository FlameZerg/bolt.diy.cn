        ...
        <div className="text-center space-y-2">
          ...
          {showProgress && progressSteps.length > 0 && (
            <div className="w-full max-w-sm">
              ...
              >
                <span>{getTranslation('showDetails', language)}</span>
                <ChevronDown
  ...
  if (error) {
    return (
      <div className={classNames('flex flex-col items-center justify-center py-8 text-center space-y-4', className)}>
        ...
        <div>
          <h3 className="text-sm font-medium text-bolt-elements-textPrimary mb-1">{getTranslation('failedToLoad', language)}</h3>
