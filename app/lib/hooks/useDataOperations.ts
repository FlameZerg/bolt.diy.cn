...
export function useDataOperations({
  ...
  const handleExportSettings = useCallback(async () => {
    ...
    toast.loading(getTranslation('toastPreparingSettingsExport', language), {
      position: 'bottom-right',
      autoClose: 3000,
    ...
    try {
      ...
      toast.success(getTranslation('toastSettingsExported', language), {
        position: 'bottom-right',
        autoClose: 3000,
      });
      ...
      toast.error(`${getTranslation('toastFailedExportSettings', language)}: ${error instanceof Error ? error.message : getTranslation('unknownError', language)}`, {
        position: 'bottom-right',
        autoClose: 3000,
      });
    } finally {
  ...
  const handleExportSelectedSettings = useCallback(
    async (categoryIds: string[]) => {
      if (!categoryIds || categoryIds.length === 0) {
        toast.error(getTranslation('toastNoSettingsSelected', language), {
          position: 'bottom-right',
          autoClose: 3000,
        });
        return;
      ...
      toast.loading(getTranslation('toastPreparingExportCategories', language).replace('{count}', categoryIds.length.toString()), {
        position: 'bottom-right',
        autoClose: 3000,
        toastId: 'progress-toast',
      });
      ...
      try {
        ...
        toast.success(getTranslation('toastCategoriesExported', language).replace('{count}', categoryIds.length.toString()), {
          position: 'bottom-right',
          autoClose: 3000,
        });
  ...
  const handleExportAllChats = useCallback(async () => {
    if (!db) {
      toast.error(getTranslation('toastDatabaseNotAvailable', language), {
        position: 'bottom-right',
        autoClose: 3000,
      });
      return;
    ...
    toast.loading(getTranslation('toastPreparingChatsExport', language), {
      position: 'bottom-right',
      autoClose: 3000,
      toastId: 'progress-toast',
    });
    ...
    try {
      ...
      toast.success(getTranslation('toastChatsExported', language).replace('{count}', exportData.chats.length.toString()), {
        position: 'bottom-right',
        autoClose: 3000,
      });
      ...
      toast.error(`${getTranslation('toastFailedExportChats', language)}: ${error instanceof Error ? error.message : getTranslation('unknownError', language)}`, {
        position: 'bottom-right',
        autoClose: 3000,
      });
    } finally {
  ...
  const handleExportSelectedChats = useCallback(
    async (chatIds: string[]) => {
      ...
      if (!chatIds || chatIds.length === 0) {
        toast.error(getTranslation('toastNoChatsSelected', language), {
          position: 'bottom-right',
          autoClose: 3000,
        });
        return;
      ...
      toast.loading(getTranslation('toastPreparingExportChats', language).replace('{count}', chatIds.length.toString()), {
        position: 'bottom-right',
        autoClose: 3000,
        toastId: 'progress-toast',
      });
      ...
      try {
        ...
        toast.success(getTranslation('toastChatsExported', language).replace('{count}', filteredChats.length.toString()), {
          position: 'bottom-right',
          autoClose: 3000,
        });
  ...
  const handleImportSettings = useCallback(
    async (file: File) => {
      ...
      toast.loading(getTranslation('toastImportingSettingsFrom', language).replace('{file}', file.name), {
        position: 'bottom-right',
        autoClose: 3000,
        toastId: 'progress-toast',
      });
      ...
      try {
        ...
        toast.success(getTranslation('toastSettingsImported', language), {
          position: 'bottom-right',
          autoClose: 3000,
        });
        ...
        toast.error(`${getTranslation('toastFailedImportSettings', language)}: ${error instanceof Error ? error.message : getTranslation('unknownError', language)}`, {
          position: 'bottom-right',
          autoClose: 3000,
        });
      } finally {
  ...
  const handleImportChats = useCallback(
    async (file: File) => {
      ...
      toast.loading(getTranslation('toastImportingChatsFrom', language).replace('{file}', file.name), {
        position: 'bottom-right',
        autoClose: 3000,
        toastId: 'progress-toast',
      });
      ...
      try {
        ...
        toast.success(getTranslation('toastChatsImported', language).replace('{count}', validatedChats.length.toString()), {
          position: 'bottom-right',
          autoClose: 3000,
        });
        ...
        toast.error(`${getTranslation('toastFailedImportChats', language)}: ${error instanceof Error ? error.message : getTranslation('unknownError', language)}`, {
          position: 'bottom-right',
          autoClose: 3000,
        });
      } finally {
  ...
  const handleImportAPIKeys = useCallback(
    async (file: File) => {
      ...
      toast.loading(getTranslation('toastImportingApiKeysFrom', language).replace('{file}', file.name), {
        position: 'bottom-right',
        autoClose: 3000,
        toastId: 'progress-toast',
      });
      ...
      try {
        ...
        toast.success(
          getTranslation('toastApiKeysImported', language).replace('{count}', keyCount.toString()).replace('{new}', newKeyCount.toString()) + '\n' +
          getTranslation('toastApiKeysNote', language),
        ...
        toast.error(`${getTranslation('toastFailedImportApiKeys', language)}: ${error instanceof Error ? error.message : getTranslation('unknownError', language)}`, {
          position: 'bottom-right',
          autoClose: 3000,
        });
      } finally {
  ...
  const handleResetSettings = useCallback(async () => {
    ...
    toast.loading(getTranslation('toastResettingSettings', language), {
      position: 'bottom-right',
      autoClose: 3000,
      toastId: 'progress-toast',
    });
    ...
    try {
      if (db) {
        ...
        toast.success(getTranslation('toastSettingsReset', language), {
          position: 'bottom-right',
          autoClose: 3000,
        });
      ...
      toast.error(`${getTranslation('toastFailedResetSettings', language)}: ${error instanceof Error ? error.message : getTranslation('unknownError', language)}`, {
        position: 'bottom-right',
        autoClose: 3000,
      });
    } finally {
  ...
  const handleResetChats = useCallback(async () => {
    ...
    toast.loading(getTranslation('toastDeletingAllChats', language), {
      position: 'bottom-right',
      autoClose: 3000,
      toastId: 'progress-toast',
    });
    ...
    try {
      ...
      toast.success(getTranslation('toastAllChatsDeleted', language), {
        position: 'bottom-right',
        autoClose: 3000,
      });
      ...
      toast.error(`${getTranslation('toastFailedDeleteChats', language)}: ${error instanceof Error ? error.message : getTranslation('unknownError', language)}`, {
        position: 'bottom-right',
        autoClose: 3000,
      });
    } finally {
  ...
  const handleDownloadTemplate = useCallback(async () => {
    ...
    toast.loading(getTranslation('toastCreatingTemplate', language), {
      position: 'bottom-right',
      autoClose: 3000,
      toastId: 'progress-toast',
    });
    ...
    try {
      ...
      toast.success(getTranslation('toastTemplateDownloaded', language), {
        position: 'bottom-right',
        autoClose: 3000,
      });
    } catch (error) {
      ...
      toast.error(`${getTranslation('toastFailedDownloadTemplate', language)}: ${error instanceof Error ? error.message : getTranslation('unknownError', language)}`, {
        position: 'bottom-right',
        autoClose: 3000,
      });
    } finally {
